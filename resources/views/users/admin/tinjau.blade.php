    ...
    <div class="overflow-auto mt-3" style="max-height: 400px;">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <img src="{{ asset('/' . $foto->ftphn) }}" class="img-thumbnail" alt="fotorth" width="100%">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/' . $foto->ftphn) }}" class="btn btn-success w-100">
        ...
        <div class="row">
            ...
            @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <img src="{{ asset('/' . $lmrec) }}" class="img-thumbnail" alt="lmrec" width="100%">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/' . $lmrec) }}" class="btn btn-success w-100">
                    <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Pdf {{ $index }}
                </button>
            </div>
            @php
        ...
        <div class="card-body">
            ...
            @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
            <div class="mb-3">
                <img src="{{ asset('/' . $fotoktp) }}" class="img-thumbnail" alt="fotoktp" width="50%">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="mb-3">
                <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/' . $fotoktp) }}" class="btn btn-success">
        ...
        <div class="row">
            ...
            @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <img src="{{ asset('/' . $survei) }}" class="img-thumbnail" alt="survei" width="100%">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/' . $survei) }}" class="btn btn-success w-100">
                    <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Pdf {{ $index }}
                </button>
            </div>
            @php
        ...
        <div class="row">
            ...
            @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <img src="{{ asset('/' . $surat) }}" class="img-thumbnail" id="surat" alt="surat" width="100%">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/' . $surat) }}" class="btn btn-success w-100">
                    <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Pdf {{ $index }}
                </button>
            </div>
            @php
        ...
        <div class="row">
            ...
            @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <img src="{{ asset('/' . $pelaksana) }}" class="img-thumbnail" alt="pelaksana" width="100%">
            </div>
            @elseif($fileExtension === 'pdf')
            <div class="col-12 col-md-4 col-lg-3 mb-3">
                <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/' . $pelaksana) }}" class="btn btn-success w-100">
                    <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Pdf {{ $index }}
                </button>
            </div>
            @php
