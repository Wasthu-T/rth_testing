...
<form action="/dashboard/profil/ubah" method="POST">
    ...
    <div class="form-floating mb-3">
        <input required name="email" type="email" class="@error('email') is-invalid @enderror form-control rounded-3" id="email" placeholder="name@example.com" value="{{auth()->user()->email}}">
