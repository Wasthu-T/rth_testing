...
$.when(
    getDataFromCacheOrServer('desa'),
    getDataFromCacheOrServer('kabupaten'),
    getDataFromCacheOrServer('rth'),
    getDataFromCacheOrServer('jln')
).done(function (geojsonDesa, geojsonKabupaten, geojsonRth, geojsonJln) {
    // Menyimpan layer GeoJSON untuk referensi
    var desaLayer, kabupatenLayer, rthLayer, jlnLayer, lastClickedLayer, previousMarker;
    ...
    document.querySelectorAll('.filterJln').forEach(function (element) {
        element.addEventListener('click', function () {
            ...
            desaLayer = addGeoJSONLayer(geojsonDesa, styleJln, desaLayer);
